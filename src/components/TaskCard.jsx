...
const TaskCard = ({
  ...
  return (
    <div className="bg-white/10 flex main justify-between items-center mb-4 backdrop-blur-md border border-white/30 rounded-lg shadow-2xl w-[100%] p-4 pb-2 taskcardMain">
      <div className="text-white w-[70%]">
        <div className="flex gap-1 adjust">
          {editTask ? (
            <>
              <input
                type="text"
      ...
      <div className="flex gap-4 text-[#147762] text-xl w-[40%] justify-end iconContr ">
